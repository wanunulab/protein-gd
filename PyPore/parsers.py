...
class FilterDerivativeSegmenter( parser ):
    ...
    def GUI( self ):
        ...
        grid = Qw.QGridLayout()
        grid.addWidget( Qw.QLabel( "Low-pass Threshold: " ), 0, 0 )
        grid.addWidget( Qw.QLabel( "High-pass Threshold: " ), 1, 0 )

        self.lowThreshInput = Qw.QLineEdit()
        ...
        self.highThreshInput = Qw.QLineEdit()
